    ...
    <>
      ...
      <div className="about-container">
        ...
        <div className="about-content reverse">
          ...
          <motion.div className="about-text">
            <h2>Our Vision</h2>
            <p>We envision a world where no food goes to waste while millions go hungry. By leveraging technology and community support, 
            we aim to create a seamless system for food redistribution, ensuring that every meal counts.</p>
          </motion.div>
        </div>
        ...
        >
          ...
          <ul>
            ...
            <li><strong>Step 3:</strong> Volunteers coordinate transportation and delivery.</li>
            <li><strong>Step 4:</strong> Meals reach those in need, reducing food waste.</li>
          </ul>
        </motion.div>
      </div>
      ...
      <div className="contact-container">
        ...
        <p className="contact-email">Email: <a href="mailto:support@hungerheal.org">support@hungerheal.org</a></p>
      </div>
    </>
  );
};
